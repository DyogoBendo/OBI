...
def main(file_input=input, test=False):
    p1 = tuple(map(int, file_input().split()))
    p2 = tuple(map(int, file_input().split()))
    p3 = tuple(map(int, file_input().split()))
    p4 = tuple(map(int, file_input().split()))
    p5 = tuple(map(int, file_input().split()))
    p6 = tuple(map(int, file_input().split()))
    p7 = tuple(map(int, file_input().split()))
